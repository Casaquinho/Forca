...
# while erros != 0:
#     tentativa = input(f"digite a {contador}° letra: ")
#     if  tentativa in EscolhaRandom:
#         EstruturaPalavra.pop(contador)
#         EstruturaPalavra.insert(contador,tentativa)
#         print(EstruturaPalavra)
#         contador + 1
#     else:
#         erros = erros - 1
#         Letras_Erradas.append(tentativa)
...
#     print(f"Estrutura:    {EstruturaPalavra}")
#     tentativa = input(f"{i}° tentativa:  ")

#     if tentativa in EscolhaRandom[i]:
#         indexEscolha = EscolhaRandom.index(tentativa)
#         print(indexEscolha)
#         EstruturaPalavra.pop(i)
#         EstruturaPalavra.append(tentativa[indexEscolha])
#         print(EstruturaPalavra)
# else:
#     erros = erros - 1
#     Letras_Erradas.append({tentativa})
#     print(f"erros = {Letras_Erradas}")
    ...
    # listaForca = ["computador", "colégio", "Carro", "abacaxi", "garrafa","Flamengo","Macarrao","Computador","telefone" ]

    # EscolhaRandom = random.choice(listaForca)
    ...
    # while erros != 0:
    #     tentativa = input(f"digite a letra: ")
    #     if tentativa not in(Letras_Erradas) and tentativa not in Palavra:
    #                                                     #index mais prático
    #         for indice,valor in enumerate(EscolhaRandom): #enumerate pegará a posição(indice) e valor de cada item na lista
    #             if tentativa == valor:            
